...
# 
# The basic idea is that for each project that you manage, you establish what is called a *repository* for that project with git. That repository contains the files for your project, and using various commands you can instruct it what to do when you make changes to your files. 
# 
...
# ```
# 
# You can use bash to perform very complicated processing. If you are interested, read more about bash scripting [here](https://flaviocopes.com/bash/) . Knowing bash scripting will save you so many hastles down the line!
