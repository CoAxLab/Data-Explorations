...
# install.packages("repr") # if you don't have repr library installed, uncomment this
library(repr)
...
# Here we will predict what the weight would be if 
# the width for the car is 165, 180, or 195 inches.
